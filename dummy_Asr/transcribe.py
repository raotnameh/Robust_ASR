...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--gpu', default='0',type=str, help='Returns time offset information')
    ...
    with open('out.txt', "w") as f:
        f.write(json.dumps((decode_results(decoded_output, decoded_offsets)['output'][0]["transcription"])))
