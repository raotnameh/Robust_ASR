...
parser.add_argument('--noise-max', default=0.2,
...
if __name__ == '__main__':
        ...
        if not args.finetune: # If continuing training after the last epoch.
            if args.using_new:
                ...
                for i in models:
                    ...
                    #if arhs.lr: models[i][-1].param_groups[0]['lr'] = args.lr
                del dummy
    ...
    test_loader = AudioDataLoader(test_dataset, batch_size=int(args.batch_size),
