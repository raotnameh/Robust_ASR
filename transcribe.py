...
beam_args.add_argument('--beam-width', default=124, type=int, help='Beam width to use')
...
beam_args.add_argument('--lm-workers', default=24, type=int, help='Number of LM processes to use')
