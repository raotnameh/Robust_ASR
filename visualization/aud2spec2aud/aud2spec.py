...
parser.add_argument('-mp','--mag-path',type=str,help='Path to save the mag')
parser.add_argument('-pp','--phase-path',type=str,help='Path to save the phase')
...
def aud_to_spect(original_audio,n_fft,hop_length,win_length,window,mag_path,phase_path):
...
if __name__ == "__main__":
    ...
    aud_to_spect(original_audio,n_fft,hop_length,win_length,window,mag_path+audio_path.split("/")[-1][:-4],phase_path+audio_path.split("/")[-1][:-4])