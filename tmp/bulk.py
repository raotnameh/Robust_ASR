...
arg_parser.add_argument('--m1', type=float, help='to use bert to score the beams or no')
arg_parser.add_argument('--m2', type=float, help='to use bert to score the beams or no')
